...
<head>
    ...
    <title>B.R.U.H. - Create Account</title>
...
<body class="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md bg-card border border-border rounded-2xl shadow-2xl p-8 relative z-10">
        ...
        <div class="flex flex-col items-center mb-8">
            <div class="h-14 w-14 bg-primary/10 rounded-full flex items-center justify-center mb-4 border border-primary/20">
                <i data-lucide="sprout" class="h-7 w-7 text-primary"></i>
            </div>
            <h1 class="text-2xl font-extrabold tracking-tight text-foreground">Join B.R.U.H.</h1>
            <p class="text-sm text-muted-foreground mt-2">Start managing your urban habitat today</p>
        </div>
        ...
        <form action="/auth/register" method="POST" class="space-y-4">
            ...
            <div class="space-y-2">
                <label for="confirm_password" class="text-sm font-semibold text-foreground">Confirm Password</label>
                <div class="relative">
                    <i data-lucide="check-circle" class="absolute left-3 top-3 h-4 w-4 text-muted-foreground"></i>
        ...
        <p class="mt-8 text-center text-sm text-muted-foreground">
            ...
            <a href="/auth/login" class="text-primary hover:text-primary/80 font-semibold ml-1 transition-colors">Sign in here</a>
        </p>
    </div>
